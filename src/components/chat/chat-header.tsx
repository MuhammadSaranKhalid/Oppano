...
//   // Default title and avatar for channels and groups
//   let title = conversation.title || "Untitled";
//   let avatarSrc = `/placeholder.svg?height=32&width=32`;

//   // For private chats, override title and avatar with the other participant's details
//   if (
...
//     );
//     if (otherParticipant) {
//       title = otherParticipant?.user?.username || title;
